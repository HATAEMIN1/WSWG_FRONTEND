    ...
    return (
        <>
            ...
            <SectionWrap>
                ...
                <div className="mb-10">
                    <h2 className=" text-slate-500 font-bold">
                        모달 모달 - 버튼 스타일 말고 onClick 이벤트 값만
                        확인하세요!!!
                    </h2>
                ...
                <div className="mb-10">
                    ...
                    <div className="flex gap-2 justify-between items-center">
                        <i className="iconTypeInput iconRname">email</i>
                        <InputWrap>
                ...
                <div className="mb-10">
                    ...
                    <div className="flex gap-2 justify-between items-center">
                        ...
                        <button className={"btnFileUpload"}>파일업로드</button>
                    </div>
                </div>
                ...
                <div className="mb-10">
                    ...
                    <InputWrap className="inputContainer iconDetail">
                        <input
                            type="text"
                            placeholder="제목입력"
                            className="text-left"
                    ...
                    <InputWrap className="inputContainer iconLink">
                        <input
                            type="text"
                            placeholder="링크입력"
                            className="text-left"
                    ...
                    <InputWrap className="inputContainer iconText">
                        <input
                            type="text"
                            placeholder="댓글입력"
                            className="text-left"
